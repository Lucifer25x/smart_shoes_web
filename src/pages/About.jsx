...
export default function About() {
  return (
    <>
      ...
      <h1>Haqqında</h1>
      <p>
        Bu vebsayt “Ağıllı Ayaqqabılar” layihəsi üçün yaradılmışdır. Məqsədimiz
        görmə məhdudiyyətli insanlara kömək etmək və mövcud layihələri
        təkmilləşdirməkdir. Biz yaxınlıqdakı obyektləri aşkar edən və mexanizmin
        istifadəçisinə siqnal göndərən mexanizm yaratdıq. Mexanizm yaradılarkən
        özəlləşdirmə başlıca diqqət mərkəzlərindən biri olduğundan bizim
        mexanizmin siqnal mexanizmi də istəyə bağlı olaraq dəyişdirilə bilir.
        Siz səsli və ya titrəmə mühərrikli və ya hər ikisi ilə siqnal qəbul edə
        bilərsiniz. Bizim proyektə oxşar proyektlər daha öncə yaradılmışdır,
        lakin bu proyektlərin gündəlik istifadə üçün kifayət etmədiyini
        düşündük, bu səbəbdən funksiyalar əlavə edərək və problemlərin aradan
        qaldırılması ilə bu layihələri təkmilləşdirmək istədik. Mexanizm istəyə
        bağlı olaraq çubuq və ayaqqabı ilə istifadə edilə bilər. Amma biz onu
        ayaqqabı ilə istifadə etməyi təklif edirik. Layihəmizi yaymaq və görmə
        qabiliyyəti zəif olan insanlara başqa yollarla da kömək etmək üçün
        hal-hazırda istifadə etdiyiniz bu proqramı da yaratdıq. Bu proqramla
        görmə qabiliyyəti zəif olan şəxsin ailə üzvləri həmin şəxsin
        lokasiyasını öyrənə bilər. Görmə qabiliyyəti zəif olan şəxs ailə
        üzvlərini/dostlarını əlavə edə/silə bilər. Biz tətbiqin məxfiliyini,
        təhlükəsizliyini və sürətini bacardığımız qədər yüksək tutmağa
        çalışırıq.
      </p>
      <p>
        - Cihazı test etmək üçün onlayn simulyasiyanı açın: <span> </span>
        <a href="https://wokwi.com/projects/355939825123970049" target="_blank">
          Onlayn Simulyasiya
        </a>
